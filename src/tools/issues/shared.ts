...
import {
  isEntityError,
  getAvailableTeamsJson as getAvailableTeamsJsonFromHandler,
  getAvailableProjectsJson as getAvailableProjectsJsonFromHandler,
  getAvailableStatesJson as getAvailableStatesJsonFromHandler,
  getAvailableAssigneesJson as getAvailableAssigneesJsonFromHandler,
  getAvailableLabelsJson as getAvailableLabelsJsonFromHandler,
  getAvailableProjectMilestonesJson as getAvailableProjectMilestonesJsonFromHandler,
...
// --- Validation helpers --- (Removed as per new instructions)
